...
var map = {
	...
	"./flight-activity/flight-activity.module": [
...
const routes = [
    {
        path: '',
        loadChildren: () => __webpack_require__.e(/*! import() | home-tabs-tabs-module */ "home-tabs-tabs-module").then(__webpack_require__.bind(null, /*! ./home/tabs/tabs.module */ "./src/app/home/tabs/tabs.module.ts")).then(m => m.TabsPageModule)
    },
    {
        path: 'flight',
...
let GeneralService = class GeneralService {
    constructor(router, activatedRoute, location, toastController, loadingController) {
        this.router = router;
    ...
    presentLoading(messages = "Please wait...") {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
    ...
    showLoading(messages = "Please wait...") {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
...
module.exports = __webpack_require__(/*! D:\Codes\angkasa_pura\src\main.ts */"./src/main.ts");
